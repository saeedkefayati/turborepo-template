...
The repository uses pnpm workspaces and Turborepo to coordinate applications and
shared packages.
...
Once the repository toolchain has been installed, normal development uses pnpm
directly.
...
The repository contracts mean that UI validation does not require separate
