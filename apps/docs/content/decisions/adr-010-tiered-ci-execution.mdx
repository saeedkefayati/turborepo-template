...
ADR-011 standardizes the repository quality-command contract used by local
hooks and GitHub Actions.

This does not change the Fast CI versus Full CI selection policy defined by this
ADR.

The CI tiers continue to use the same trigger and platform strategy while
consuming the unified repository commands.
